...
// ---------------------------- 카카오 지도 표시 ------------------------ //
	...
	// 1. 현재 접속한 클라이언트 [ 브라우저] 의 좌표 구하기
navigator.geolocation.getCurrentPosition(e =>{
	console.log(e);
	console.log(e.coords);
	console.log(e.coords.latitude);
	console.log(e.coords.longitude);
	let currentat = e.coords.latitude;
	let currenting = e.coords.longitude;
	
	// 지도를 표시할 div

	var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
	    mapOption = { 
	        center: new kakao.maps.LatLng(currentat, currenting), // 지도의 중심좌표
	        level: 3 // 지도의 확대 레벨
	    };
