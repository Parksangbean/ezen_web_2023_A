...
document.body.style = 'background-color : yellow;  font - size : 20px; color: red;';
...
// 4. addEventListener('이벤트명 ' , 함수);
	...
	*/
	/*
		1.	DOMContentLoaded : HTML이 완전히 열렸을때[모드 로드되었을때] 실행되는 이벤트
...
//1. HTML이 완전히 열렸을때
 ...
 //2.해당 객체가 호출 되었을때
window.onload=() => {console.log('js 에서 이벤트 실행2'); }

//3. js가 열렸을때 이벤트 1번 실행
console.log('js 에서 이벤트 실행 3')
