...
public class Ex3_예제 {
	...
	public static void main(String[] args) {
		...
		// Map<String , Integer>map = new HashMap<>(); // 2000개씩 저장이 안되거나 오류 발생 [ 비동기 = 여러 스레드가 동시에 한 메소드에게 요청할때 대기 없으면 ]
		
		// 2. // ----- 멀티스레드를 이용한 각 1000개씩 2000개씩 동시 저장
		...
		System.out.println("map 상태 : "+map); // 두 스레드가 저장을 하기 전에  main 스레드 출력 먹저 했기때문에
	}
}
