...
public class Level1_9 {
	...
	public static void main(String[] args) {
		...
		int sum = kor+eng+mat;
		float average =(kor+eng+mat)/3;
		/* 문제풀이 위치 */
		System.out.printf("%d %6d %6d %6d %5.1f %6s %6s %4s %3s",kor,eng,mat,sum,
				average,sum%3==0,sum%8==0,sum%2==0?"짝수":"홀수", sum>=65?"합격":"탈락");
		/* ----------- */
	}
}
/* 
